...
const games = [
  ...
  },
  {
    ...
    tag: "2v2",
    blurb:
      "Two teams, two-digit numbers, and a birdie flip that swings the pot. The high-stakes team gambling game.",
    Icon: VegasIcon,
    accent: "#d98a2b",
  },
  {
    ...
    tag: "2 players",
    blurb:
      "Head-to-head, hole by hole. Track who's up and when the match is closed out — 2 up, all square, or 3 & 2.",
    Icon: MatchPlayIcon,
    accent: "#8b7cf0",
  },
  {
